    ...
    return (
      <View>
        ...
        <View style={{alignSelf: 'center', marginVertical: 6}}>
          <TouchableOpacity>
            {this.state.image !== '' ? (
              <Image
                ...
                style={[
                  styles.userImage,
                  {resizeMode: 'contain', backgroundColor: '#ccc'},
                ]}
              />
            ) : (
              <TouchableOpacity
          ...
          <Text style={{textAlign: 'center', fontSize: 18, marginVertical: 6}}>
            User name
          </Text>
        </View>
        <HomePageTitle
          onPress={() => this.navigate('ManageVideoScreen')}
          type={'entypo'}
          name={'video'}
          title={'Manage Videos'}
        />
        <HomePageTitle
          onPress={() => this.navigate('ManageProductScreen')}
          type={'antdesign'}
          name={'book'}
          title={'Manage Products'}
        />
        <HomePageTitle
          onPress={() => this.navigate('ManageClassified')}
          type={'font-awesome'}
          name={'newspaper-o'}
          title={'Manage Classifieds'}
        />
        <HomePageTitle
          onPress={() => this.navigate('Order')}
          type={'font-awesome'}
          name={'truck'}
          title={'Orders'}
        />
        ...
        />
        <HomePageTitle
          onPress={() => this.navigate('Conditions')}
          type={'font-awesome'}
          name={'file'}
